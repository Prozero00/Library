...
public class Buku extends javax.swing.JFrame {
    ...
    public void LoadTable() {
        ...
        try {
            pst = con.prepareStatement("SELECT * FROM buku ORDER BY id_buku");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        txtPengarang.setBounds(110, 370, 270, 30);
        ...
        if (tblBuku.getColumnModel().getColumnCount() > 0) {
            ...
            tblBuku.getColumnModel().getColumn(0).setPreferredWidth(10);
        }

        jPanel3.add(jScrollPane1);
        jScrollPane1.setBounds(20, 120, 600, 180);
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        String pengarang = txtPenerbit.getText();
        String penerbit = txtPenerbit.getText();
        String tahunTerbit = txtTahun.getText();
        int jumlah = Integer.parseInt(txtJumlah.getText());

        try {
            pst = con.prepareStatement("INSERT INTO buku(judul,pengarang,penerbit,tahun_terbit,jumlah_buku) VALUES(?,?,?,?,?)");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) tblBuku.getModel();
        int selectIndex = tblBuku.getSelectedRow();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            pst = con.prepareStatement("UPDATE buku SET judul=?,pengarang=?,penerbit=?,tahun_terbit=?,jumlah_buku=? WHERE id_buku=?");
            pst.setInt(6, id);
            pst.setString(1, judul);
            pst.setString(2, pengarang);
            pst.setString(3, penerbit);
    ...
    private void tblBukuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBukuMouseClicked
        ...
        int id = Integer.parseInt(model.getValueAt(selectIndex, 0).toString());
        txtJudul.setText(model.getValueAt(selectIndex, 1).toString());
        txtPengarang.setText(model.getValueAt(selectIndex, 2).toString());
        txtPenerbit.setText(model.getValueAt(selectIndex, 3).toString());
        txtTahun.setText(model.getValueAt(selectIndex, 4).toString());
        txtJumlah.setText(model.getValueAt(selectIndex, 5).toString());
